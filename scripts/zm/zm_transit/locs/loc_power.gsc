...
init_wallbuys()
{
	scripts\zm\_gametype_setup::wallbuy( "rottweil72_zm", "olympia", "weapon_upgrade", ( 11769, 7662, -701 ), ( 0, 170, 0 ) );
	scripts\zm\_gametype_setup::wallbuy( "m16_zm", "m16", "weapon_upgrade", ( 10859, 8146, -353 ), ( 0, 0, 0 ) );
	scripts\zm\_gametype_setup::wallbuy( "mp5k_zm", "mp5", "weapon_upgrade", ( 11452, 8692, -521 ), ( 0, 90, 0 ) );
	scripts\zm\_gametype_setup::wallbuy( "bowie_knife_zm", "bowie_knife", "bowie_upgrade", ( -4280, -7486, -5 ), ( 0, 180, 0 ) );
}
