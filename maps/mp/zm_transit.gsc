...
register_perk_structs()
{
	switch ( getDvar( "ui_zm_mapstartlocation" ) )
	{
		...
		case "power":
			...
			_register_survival_perk( "specialty_rof", "zombie_vending_doubletap2", ( 0, -138, 0 ), ( 11879, 7296, -755 ) );
			_register_survival_perk( "specialty_longersprint", "zombie_vending_marathon", ( 0, -35, 0 ), ( 10856, 7879, -576 ) );
			_register_survival_perk( "specialty_scavenger", "zombie_vending_tombstone", ( 0, 270, 0 ), ( 10946, 8308.77, -408 ) );
			_register_survival_perk( "specialty_weapupgrade", "p6_anim_zm_buildable_pap_on", ( 0, 162, 0 ), ( 12625, 7434, -755 ) );
			_register_survival_perk( "specialty_quickrevive", "zombie_vending_quickrevive", ( 0, -4, 0 ), ( 11156, 8120, -575 ) );
